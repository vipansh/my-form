    ...
    return (
        <>
            <div className="flex flex-row md:flex-col w-full md:w-auto  md:my-4  fixed bottom-0 left-0  md:ml-16 rounded-lg bg-gray-200 justify-around md:static z-40 ">
                ...
                <div className="flex  items-center cursor-pointer rounded-md m-2 " onClick={() => { addOne() }}><span className="rounded-full hover:bg-gray-400 p-2"><svg className="h-8 inline " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg></span></div>



                <div className="flex items-center cursor-pointer rounded-md m-2"><span className="rounded-full hover:bg-gray-400 p-2"><svg className="h-8 inline " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg></span></div>

                <div className="flex relative items-center cursor-pointer rounded-md m-2"><span className="rounded-full hover:bg-gray-400 p-2" onClick={() => { setSaveWarning(true) }}><svg className="h-8 inline " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className={`flex items-center  rounded-md m-2  + ${allQuestions ? " cursor-pointer " : " cursor-not-allowed "}`} onClick={() => { removeOne() }}>  <span className=" text-red-300 hover:text-red-800 p-2"  > <svg className="h-8 inline " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const SavePopUp = ({ show, saveForm }) => {
    ...
    return (
        <div className=" flex flex-col rounded-lg bg-white border " >
            < div className="bg-white opacity-25 rounded-lg  absolute z-10 inset-0 " ></div >
            <div className="bg-white rounded-lg md:max-w-md md:mx-auto p-4 fixed inset-x-0 bottom-0 z-50 mb-4 mx-4 md:relative">
                <div className="flex md:flex-col items-center ">
                    ...
                    <div className="mt-4 md:mt-0 md:ml-6 text-center md:text-left">
                        <p className="font-bold" >Save Form</p>
                        <p className="text-sm text-gray-700 mt-1">Once Saved you won't be abel to edit it.
                    </p>
                    </div>
                </div>
