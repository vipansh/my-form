        ...
        <div class="border-b shadow-lg " >
            ...
            <header class=" md:flex md:items-center md:justify-between p-4 pb-0  md:pb-4">
                ...
                <nav className="w-auto text-gray-700">
                    ...
                    <span className="mx-4">
                        <button class="inline-flex  text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" style={{ backgroundColor: formData.color }}>Share</button></span>
